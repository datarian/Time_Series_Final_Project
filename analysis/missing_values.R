...
modelComparisonImputationTable2 <- rbind(data.frame(Approach="Original with sd as ARMA(1,1)",
                                         ...
                                         data.frame(Approach="Original with sd lin. interpolated.",
                                         ...
                                         data.frame(Approach="Original with true sd",
