...
The supplier of the data recommended to ignore data after 1800 due to an insufficient amount of data. For this analysis, data that was collected above 900 meters will be used.

## Spruce data above 900 m
As said before, the chronology of interest for this project is compiled from buildings in the Bernese Oberland which are all located above 900 meters. Spruce was a common building material and there is a wealth of houses supplying data. The data can be assumed to originate almost entirely from trees that grew above 900 meters because trees were almost never transported uphill for building houses. We can also assume that freshly cut timber was used to construct the houses. Hence, by knowing when the house was built tree ring data can be dated.
